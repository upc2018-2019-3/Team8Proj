...
public class StudentAction extends ActionSupport implements SessionAware, RequestAware{
	...
	public String register() {
		String city = studentRegister.getCity();
		String district = studentRegister.getDistrict();
		...
		if(school == null){
			school = new School();
			school.setCity(cityService.getCity(city));
			school.setDistrict(district);
			school.setSchoolName(studentRegister.getSchoolName());
			school.setAddress(city + district);
			schoolService.add(school);
			school = schoolService.getSchool(city, district, studentRegister.getSchoolName());
		}
	...
	public void registerJson() throws Exception {
		...
		City existCity = cityService.getCity(cityName);
		if(existCity == null){
			City c= new City();
		...
		if(school == null){
			school = new School();
			school.setCity(cityService.getCity(cityName));
			school.setDistrict(district);
			school.setSchoolName(schoolName);
			school.setAddress(cityName + district);
			schoolService.add(school);
			school = schoolService.getSchool(cityName, district, studentRegister.getSchoolName());
		}
	...
	public String list()
	{
		try {
			...
			request.put("cityList",studentList);
		}catch(Exception x)
		{
			x.printStackTrace();
			return "input";
